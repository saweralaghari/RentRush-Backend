...
const images = [
  { src: "/src/assets/carad1.jpg", alt: "Image 1" },
  { src: "/src/assets/carad2.jpg", alt: "Image 2" },
  { src: "/src/assets/carad2.jpg", alt: "Image 3" },
...
const UserDashboard = () => {
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-0 lg:p-0  mb-6">
    <div
    ...
    >
      ...
      />
      <h2 className="text-2xl text-white font-semibold ">Cars</h2>
    ...
    >
      <img
        ...
        className="w-full h-40 object-cover mb-4 rounded-lg"
      />
      <h2 className="text-2xl text-white font-semibold mb-8">Showrooms</h2>
